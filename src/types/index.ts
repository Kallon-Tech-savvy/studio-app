...
/** The full row shape returned by GET /api/studio/staff — used for the
 * staff-management directory, as opposed to StaffMember above which is
 * the trimmed "who am I" profile for the signed-in person. */
